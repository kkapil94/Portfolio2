        ...
        <div className="grid grid-cols-3 xs:max-md:grid-cols-1 items-center">
          <div className="col-span-2 xs:max-md:mt-8">
            <div className="text-white font-bold text-6xl flex">
              <h1 className="text-transparent xs:max-md:text-4xl md:max-lg:text-5xl bg-clip-text bg-gradient-to-r from-[#d86bff] via-[#57bac6] to-[#c7ff70]">
                <Typewriter />
              </h1>
              <h1 className="xs:max-md:text-4xl md:max-lg:text-5xl">Everyone,</h1>
            </div>
            <h1 className="xs:max-md:text-4xl md:max-lg:text-5xl lg:max-2xl:text-6xl font-bold text-white xs:max-md:mt-6 md:max-lg:mt-8 lg:max-2xl:mt-12 leading-[5rem]">
              I'm{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FFDEE9] to-[#B5FFFC]">
                Kapil
              </span>
              ,<br />
              <div className="md:max-2xl:text-xl xs:max-md:text-lg  md:max-2xl:w-4/6">
